  ...
  return (
    <View style= {styles.container}>
      <View style={{width: "100%", flexDirection:"row", justifyContent:"space-between", alignItems:"center", marginBottom:30}}>
        <Pressable onPress={()=> {navigation.navigate('home')}}><Image style={{width:20, height:20}} source={require("./assets/snack-icon.png")} /></Pressable>
        <Text style={{fontSize: 26}}>News</Text>
        <Image style={{width:20, height:20, opacity: 0}} source={require("./assets/snack-icon.png")} />
      </View>
      <View style={{width:"100%", flexDirection:"row", gap: 10}}>
      <Image  style={{width:120, height:120}} source={require("./assets/snack-icon.png")} />
